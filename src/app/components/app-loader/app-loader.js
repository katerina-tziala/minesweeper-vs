...
export class AppLoader {
	...
	static stopSpinner() {
		AppLoader.spinner.then(spinner => ElementHandler.removeStyleClass(spinner, DOM_ELEMENT_CLASS.spin));
	}

	static startSpinner() {
		AppLoader.spinner.then(spinner => ElementHandler.addStyleClass(spinner, DOM_ELEMENT_CLASS.spin));
	}
