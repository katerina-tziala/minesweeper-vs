...
export const CONTROLL_BUTTONS = {
    up: {
        className: "btn-icon btn-primary number-input-control-btn number-input-control-btn--up",
        attributes: {
    ...
    down: {
        className: "btn-icon btn-primary number-input-control-btn number-input-control-btn--down",
        attributes: {
